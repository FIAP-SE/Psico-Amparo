...
import alexandreImg from '../../assets/perfis/alexandre.png';
    ...
    <div> 
      ...
      <div className="perfil-container">
        <div className="perfil-sidebar">
          <img src={alexandreImg} alt="Foto Alexandre" className="foto-circulo" />
        ...
        <div className="perfil-agendamentos">
          ...
          <div className="agendamento-section">
            ...
            <div className="agendamento-card">
              <img src={alessandraImg} alt="Foto Alessandra" className="foto-circulo" />
              <div className="agendamento-info">
